...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    boliviaPaquetes: Schema.Attribute.Component<'section.machupicchu', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cardPost: Schema.Attribute.Component<'section.section-card-post', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    premios: Schema.Attribute.Component<'section.certifications', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    sectionMapi: Schema.Attribute.Component<'section.machupicchu', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    preguntasAcordeon: Schema.Attribute.Component<'tours.acordeon', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    portadaImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    badge: Schema.Attribute.Component<'shared.badges', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cardBadge: Schema.Attribute.Enumeration<['best_seller', 'promocion']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    tab: Schema.Attribute.Component<'tours.tab', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
